...
class Post(models.Model):
   ...
   # FOOD_MANAGMENT = "FM"
   # CATEGORYS_CHOICES = (
    #    (INFORMATION_TECHNOLOGY, "Айти"),
    #    (SPORT, "Спорт"),
    #    (CARS, "Машины"),
      #  (POLITICS, "Политика"),
      #  (FOOD_MANAGMENT, "Управление качесвом продуктов питания")
  #  )

    categoryTypes = models.CharField(max_length=2, choices=CATEGORY_CHOICES, default=ARTICLE)
    dateCreation = models.DateTimeField(auto_now_add=True)
    #postCategory = models.CharField(max_length=3, choices=CATEGORYS_CHOICES, default = INFORMATION_TECHNOLOGY)
